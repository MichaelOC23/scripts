...
REQUIREMENTS_FILE="${SCRIPT_DIR}/streamlit/requirements.streamlit.txt"
...
echo -e "\n\n\033[4;32mProceeding with the installation of all Streamlit libraries ...\033[0m"
pip install -r ${REQUIREMENTS_FILE} || {
    echo -e "\033[1;31mRequirements installation failed\033[0m"
    exit 1v
}
REQUIREMENTS_FILE="${SCRIPT_DIR}/flask/requirements.flask.txt"
echo -e "\n\n\033[4;32mProceeding with the installation of all Flask libraries ...\033[0m"
pip install -r ${REQUIREMENTS_FILE} || {
    echo -e "\033[1;31mRequirements installation failed\033[0m"
    exit 1
}
