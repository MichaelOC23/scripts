...
# @app.route('/ollama/', methods=['GET', 'HEAD'])
# def auth_redirect():
#     print("auth_redirect function called")  # Log message to confirm function call

#     if request.method == 'HEAD':
#         # Print headers and other request information
#         print("Headers:", request.headers)
#         print("Args:", request.args)
#         print("Form:", request.form)
        
#         # Flask's request.json is None for HEAD requests, so no payload
