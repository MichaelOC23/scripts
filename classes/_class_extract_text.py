...
if __name__ == '__main__':
    ...
    # # pdf_path = 'example.pdf'
    directory_path = '/Users/michasmi/Downloads/jpmorgan'
    ...
    with open(f'/Users/michasmi/Downloads/allresearch_alltext.json', 'w') as f:
        f.write(json.dumps(ext_text.all_extracts_dict, indent=4))
        f.close()
