...
TEST_FOLDER= "/Users/michasmi/Library/CloudStorage/OneDrive-JBIHoldingsLLC/WorkingMAS/Spring/Analysis-Spring/Spring Analysis/SourceDocs/"
...
def add_title_to_file(file_path, folder_name, file_name):
    ...
    title_line = f"![[{file_name.replace("_clean.md", ".pdf")}]]"
    
    try:
        with open(file_path, 'r') as file:
            content = file.readlines()
        
        content.insert(1, title_line)
